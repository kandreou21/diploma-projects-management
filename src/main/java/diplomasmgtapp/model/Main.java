...
public class Main {
	...
	public static void main(String[] args) throws WrongStrategyException {
		...
		Application app1 = new Application(1, s1, sub1);
		Application app2 = new Application(2, s2, sub2);
		apps.add(app1);
		apps.add(app2);
		...
		BestApplicantStrategy strategy = new ExplicitAssignmentStrategy();
		...
		BestApplicantStrategy strategy1 = BestApplicantStrategyFactory.createStrategy("Explicit");
		/*
		try {
